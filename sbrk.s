...
SBRK: formato do arquivo elf64-x86-64
...
0000000000000560 <sbrk@plt>:
 560:	ff 25 6a 0a 20 00    	jmpq   *0x200a6a(%rip)        # 200fd0 <sbrk@GLIBC_2.2.5>
...
000000000000068a <main>:
 ...
 6a0:	eb 22                	jmp    6c4 <main+0x3a>
 6a2:	bf 00 00 00 00       	mov    $0x0,%edi
 6a7:	e8 b4 fe ff ff       	callq  560 <sbrk@plt>
 6ac:	48 89 c6             	mov    %rax,%rsi
 6af:	48 8d 3d ae 00 00 00 	lea    0xae(%rip),%rdi        # 764 <_IO_stdin_used+0x4>
 6b6:	b8 00 00 00 00       	mov    $0x0,%eax
 6bb:	e8 90 fe ff ff       	callq  550 <printf@plt>
 6c0:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
 6c4:	83 7d fc 1d          	cmpl   $0x1d,-0x4(%rbp)
 6c8:	7e d8                	jle    6a2 <main+0x18>
